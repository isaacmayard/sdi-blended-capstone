            ...
            <div className="col-sm-2 tw-flex ">
                <CDBSidebar textColor="#fff" backgroundColor="#000">
                    ...
                    <CDBSidebarContent className="sidebar-content">
                        <CDBSidebarMenuItem icon="user">SPC3, GRIFFIN, PETER</CDBSidebarMenuItem>
                        ...
                        <CDBSidebarMenu>
                            ...
                            <NavLink exact to="/unit" activeClassName="activeClicked">
                                <CDBSidebarMenuItem icon="book">UNIT DIRECTORY</CDBSidebarMenuItem>
                            </NavLink>
                        </CDBSidebarMenu>

                        <div className="logo">
                            <img src="/ussf_logo.png" alt="USSF_logo" width="500" height="600" />
                        </div>
                    ...
                    <Card className="card-box m-3">
                        <Card.Body>
                            <Card.Text>
                                ...
                                <hr></hr>
                                <p>DUE TODAY:</p>
                                <ul><li>QTR AWARDS</li></ul>
                                <p>DUE THIS WEEK:</p>
                                <ul><li>SERVER PROJECT</li></ul>
                                <p>DUE NEXT WEEK:</p>
                                <ul><li>MAKE MORE TASKS</li></ul>
